    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Onaylı Yorumlar Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Yorumlar</li>
          <li class="breadcrumb-item active"><a href="#">Onaylı Yorumlar Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <?php
              ...
              $toplam = say('yorumlar','yorum_durum',1);
              $lim    = 10;
              $goster = $s  * $lim -$lim;
            ...
            ?>
            <h3 class="tile-title">Onaylı Yorumlar Listesi (<?php echo $toplam; ?>)</h3>
            <?php
              if($sorgu->rowCount()){
            ?>            
