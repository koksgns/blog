    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Onay Bekleyen Yorumlar Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Yorumlar</li>
          <li class="breadcrumb-item active"><a href="#">Onay Bekleyen Yorumlar Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <?php
              ...
              $toplam = say('yorumlar','yorum_durum',0);
              $lim    = 10;
              $goster = $s  * $lim -$lim;
              ...
              $sorgu->bindValue(':d',(int) 0,PDO::PARAM_INT);
              $sorgu->execute();
              ...
              ?>
                <h3 class="tile-title">Onay Bekleyen Yorumlar Listesi (<?php echo $toplam; ?>)</h3>
            <?php
            ...
            <?php 
                ...
                echo '<div class="alert alert-danger">Onay Bekleyen Yorum Bulunmuyor</div>';
              } 
            ?>
          </div>
        </div>
