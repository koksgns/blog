        ...
        <section id="page-content">
            <div class="container">
                ...
                <div class="page-title">
                    <h1><?php echo $etiket; ?> | Etiketine ait arama sonuçları (<?php echo $toplam;?>)</h1>
                    <div class="breadcrumb float-left">
                        <ul>
                            <li><a href="#">AnaSayfa</a>
                            </li>
                            <li><a href="#"><?php echo $etiket; ?> | Etiketine ait arama sonuçları</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <ul class="pagination">
                                <?php
                                    if($toplam>$lim){
                                        pagination($s,ceil($toplam/$lim),'etiketdetay.php?etiket='.$etiket.'&s=');
                                    }
                                ?>
                        ...
                        <?php
                            ...
                            echo '<div class="alert alert-danger">'.$etiket.' Etiketine ait bir yazı bulunamadı</div>';
                        }
                    ?>
