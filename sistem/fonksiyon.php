...
function tit(){
    ...
    if($yazisef){
        ...
        $kategorilerRow     =   $kategoriler->fetch(PDO::FETCH_OBJ);

        $tit['baslik']      =   $kategorilerRow->kat_adi." - ".$sitebaslik;
        $tit['resim']       =   $site."/images/".$logo ;
        $tit['kelimeler']   =   $kategorilerRow->kat_keyw ;
        $tit['aciklama']    =   $kategorilerRow->kat_desc ;
