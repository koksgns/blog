...
<?php require_once 'inc/menu.php'; ?>        
        ...
        $sorgu  =   $db->prepare("SELECT yazi_kat_id , yazi_durum FROM yazilar INNER JOIN kategoriler ON kategoriler.id = yazilar.yazi_kat_id WHERE yazi_durum= :d AND yazi_baslik LIKE :baslik");
            ...
            <div class="container">
                ...
                <div class="page-title">
                    ...
                    <div class="breadcrumb float-left">
                        <ul>
                            ...
                            <li><a href="#"><?php echo $q; ?> | göre arama sonuçları</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                    ...
                    <?php
                        ...
                        $sorgu = $db->prepare("SELECT * FROM yazilar INNER JOIN kategoriler ON kategoriler.id = yazilar.yazi_kat_id WHERE yazi_durum= :d AND yazi_baslik LIKE :baslik ORDER BY yazi_tarih DESC LIMIT :goster,:lim");
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <ul class="pagination">
                                <?php
                                    if($toplam>$lim){
                                        pagination($s,ceil($toplam/$lim),'search.php?q='.$q.'&s=');
                                    }
                                ?>
